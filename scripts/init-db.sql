...
-- 21. TDS Certificates (Form 16 / 16A / 27D)
...
INSERT INTO permissions (id, code, name, module, description) VALUES
    ...
    ('10000000-0000-0000-0000-000000000057', 'TDS_VIEW', 'View TDS Returns & Profiles', 'TDS', 'Allows viewing TAN profiles, TDS/TCS filings and challans'),
    ('10000000-0000-0000-0000-000000000058', 'TDS_CREATE', 'Prepare TDS Returns & Challans', 'TDS', 'Allows creating TAN profiles, quarterly returns, and challans'),
    ('10000000-0000-0000-0000-000000000059', 'TDS_UPDATE', 'Modify TDS Filings & Challans', 'TDS', 'Allows updating TDS return status, recording tokens, and challans'),
    ('10000000-0000-0000-0000-000000000060', 'TDS_DELETE', 'Delete TDS Records', 'TDS', 'Allows deleting draft TDS records and entries'),
...
INSERT INTO roles (id, organization_id, code, name, description, is_system_role) VALUES
    ...
    ('20000000-0000-0000-0000-000000000010', NULL, 'TAX_PROFESSIONAL', 'Senior Tax Professional', 'Handles GST, ITR, TDS, client filings, computation and document reviews', TRUE),
    ('20000000-0000-0000-0000-000000000011', NULL, 'ACCOUNTANT', 'Staff Accountant', 'Prepares GST & TDS filings, invoices, receipts, and client data entry', TRUE),
...
WHERE code IN (
    ...
    'TDS_VIEW', 'TDS_CREATE', 'TDS_UPDATE',
