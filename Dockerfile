...
ENV PORT=8088 \
    SERVER_PORT=8088 \
    JAVA_OPTS="-Xms64m -Xmx192m -Xss384k -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=200m -XX:ReservedCodeCacheSize=48m -XX:+TieredCompilation -XX:TieredStopAtLevel=1 -XX:+UseSerialGC -XX:+ExitOnOutOfMemoryError -Djava.security.egd=file:/dev/./urandom -Dfile.encoding=UTF-8"
