...
public class CreateOrganizationRequest {
    ...
    @Schema(description = "Brand / Display name", example = "Apex & Associates Tax Advisors")
    private String name;

    @Size(max = 255, message = "Legal name cannot exceed 255 characters")
    @Schema(description = "Registered legal entity name", example = "Apex & Associates LLP")
    private String legalName;

    @Size(max = 255, message = "Trade name cannot exceed 255 characters")
    @Schema(description = "Trade or DBA name", example = "Apex Advisors")
    ...
    @Pattern(regexp = "^[0-9]{5,10}$", message = "Invalid pincode/postal code format")
    ...
    @Schema(description = "Tax Registration Number (e.g. TAN, VAT, Corporate CIN/LLPIN)", example = "LLPIN-AAO-1234")
