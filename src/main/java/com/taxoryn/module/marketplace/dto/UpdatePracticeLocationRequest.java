...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request payload to update an existing practice branch/office location")
public class UpdatePracticeLocationRequest {
    ...
    @Schema(description = "Set as the primary / headquarter location of the practice")
    private Boolean isPrimary;

    @Schema(description = "Active status flag for marketplace visibility")
