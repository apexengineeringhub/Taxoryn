...
public interface AuditLogRepository extends JpaRepository<AuditLogEntity, UUID>, JpaSpecificationExecutor<AuditLogEntity> {
    ...
    Page<AuditLogEntity> findAllByOrganizationIdAndEntityType(UUID organizationId, String entityType, Pageable pageable);
    ...
    Page<AuditLogEntity> findAllByOrganizationIdAndEntityId(UUID organizationId, String entityId, Pageable pageable);
}
