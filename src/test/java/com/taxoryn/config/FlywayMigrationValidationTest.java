...
public class FlywayMigrationValidationTest {
    ...
    void testFlywayMigrationVersionsAreUnique() throws Exception {
        ...
        assertThat(maxVersion).isEqualTo(68);
        assertThat(versionNumbers).hasSize(68);
    }
    ...
    void testFlywayInfoAndDiscovery() {
        ...
        assertThat(allMigrations.length).isEqualTo(68);
    ...
    @Test
    @DisplayName("Verify all Flyway migrations V1 to V68 resolve with valid descriptions and checksums")
