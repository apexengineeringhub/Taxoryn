...
public class FlywayMigrationValidationTest {
    ...
    void testFlywayMigrationVersionsAreUnique() throws Exception {
        ...
        assertThat(maxVersion).isEqualTo(73);
        assertThat(versionNumbers).hasSize(73);
    }
    ...
    void testFlywayInfoAndDiscovery() {
        ...
        assertThat(allMigrations.length).isEqualTo(73);
    ...
    @Test
    @DisplayName("Verify all Flyway migrations V1 to V73 resolve with valid descriptions and checksums")
