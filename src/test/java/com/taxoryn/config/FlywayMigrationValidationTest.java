...
public class FlywayMigrationValidationTest {
    ...
    void testFlywayMigrationVersionsAreUnique() throws Exception {
        ...
        assertThat(maxVersion).isEqualTo(69);
        assertThat(versionNumbers).hasSize(69);
    }
    ...
    void testFlywayInfoAndDiscovery() {
        ...
        assertThat(allMigrations.length).isEqualTo(69);
    ...
    @Test
    @DisplayName("Verify all Flyway migrations V1 to V69 resolve with valid descriptions and checksums")
